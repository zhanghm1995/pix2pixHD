...
flist="WDA_CarolynMaloney1_000" # ./datasets/test_WDA_ChrisMurphy0_000.txt

python test_face2vid.py --name HDTF_WDA_CarolynMaloney1_000_wo_noise_localG_512p_lower_neck \
                ...
                --input_rendered_face /home/zhanghm/Research/V100/TalkingFaceFormer/test_dir/AAAI/test_WDA_CarolynMaloney1_000-Silence_audio